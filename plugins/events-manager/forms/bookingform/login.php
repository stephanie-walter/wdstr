...
<div class="em-booking-login">
    ...
    <p>
		<label for="log"><?php _e( 'Username','dbem' ) ?></label>
		<input type="text" name="log" id="log" class="input" value="" />
	</p>
	<p>
		<label for="pwd"><?php _e( 'Password','dbem' ) ?></label>
		<input type="password" id="pwd" name="pwd" class="input" value="" />
    </p>
    <?php do_action('login_form'); ?>
    <p class="remember"><input name="rememberme" id="rememberme" type="checkbox" id="em_rememberme" value="forever" /> <label for="rememberme"><?php _e( 'Remember Me','dbem' ) ?></label></p>
