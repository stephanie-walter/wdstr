...
function add_login_logout_link($items, $args) {
        ...
        if ( is_user_logged_in() ) {
         ...
         $items .= '<li class="rightalign"> <ul ><li class="userprofil"> <a href="'. admin_url( 'profile.php' ).'"> Mon profil </a></li>
         <li class="loginout">'. $loginoutlink .'</li></ul></li>';	

        } 

        else{
        $items .= '<li class="rightalign"> <ul > <li class="loginout">'. $loginoutlink .'</li></ul></li>';
...
function new_excerpt_more($more) {
       global $post;
	return '<p class="readmore"> <a href="'. get_permalink($post->ID) . '"> Lire la suite</a></p>';
}
...
function my_custom_tinymce( $init ) {
	...
	$init['theme_advanced_styles'] = 'Button=btn,Align left=txtleft, Align right=txtright';
	return $init;
}
